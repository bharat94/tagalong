...
class Example extends Component {
    ...
    layoutExample (number, title, type) {
        ...
        return (
            <View style={[styles.exampleContainer, isTinder ? styles.exampleContainerDark : styles.exampleContainerLight]}>
                <Text style={[styles.title, isTinder ? {} : styles.titleDark]}>{`Event List`}</Text>
    ...
    customExample (number, title, refNumber, renderItemFunc) {
        ...
        return !IS_ANDROID ? (
            <View style={[styles.exampleContainer, isEven ? styles.exampleContainerDark : styles.exampleContainerLight]}>
                <Text style={[styles.title, isEven ? {} : styles.titleDark]}>{`Event ${number}`}</Text>
    ...
    render () {
        const example3 = this.layoutExample(3, 'Pick your favorite event', 'stack');
        ...
        return (
            <SafeAreaView style={styles.safeArea}>
                <View style={styles.container}>
                    ...
                    <Button
                      onPress={() =>
                        this.props.navigation.navigate('SelectPeople', {})
                      }
                      title="Register"
                      color="#841584"
                    />
...
const SelectEvent = StackNavigator({
  Home: { screen: Example },
